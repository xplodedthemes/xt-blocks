...
/**
 * XT_Blocks_Control_Email class.
 */
class XT_Blocks_Control_Email extends XT_Blocks_Control {
    /**
     * Constructor
     */
    ...
    public function register_assets() {
        wp_register_script(
            'xtblocks-control-email',
            xtblocks()->plugin_url() . 'controls/email/script.min.js',
    ...
    public function get_script_depends() {
        return array( 'xtblocks-control-email' );
    }
}

new XT_Blocks_Control_Email();
