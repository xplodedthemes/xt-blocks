...
/**
 * XT_Blocks_Control_ClassicEditor class.
 */
class XT_Blocks_Control_ClassicEditor extends XT_Blocks_Control {
    /**
     * Constructor
     */
    public function __construct() {
        ...
        $this->type     = 'string';
        $this->label    = __( 'Classic Editor (WYSIWYG)', 'xt-blocks' );
    ...
    public function register_assets() {
        wp_register_script(
            'xtblocks-control-classic-editor',
            xtblocks()->plugin_url() . 'controls/classic_editor/script.min.js',
    ...
    public function get_script_depends() {
        return array( 'xtblocks-control-classic-editor' );
    }
}

new XT_Blocks_Control_ClassicEditor();
