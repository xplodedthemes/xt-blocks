...
/**
 * XT_Blocks_Control_Password class.
 */
class XT_Blocks_Control_Password extends XT_Blocks_Control {
    /**
     * Constructor
     */
    public function __construct() {
        ...
        $this->type       = 'string';
        $this->label      = __( 'Password', 'xt-blocks' );
    ...
    public function register_assets() {
        wp_register_script(
            'xtblocks-control-password',
            xtblocks()->plugin_url() . 'controls/password/script.min.js',
    ...
    public function get_script_depends() {
        return array( 'xtblocks-control-password' );
    }
}

new XT_Blocks_Control_Password();
