...
/**
 * XT_Blocks_Control_URL class.
 */
class XT_Blocks_Control_URL extends XT_Blocks_Control {
    /**
     * Constructor
     */
    ...
    public function register_assets() {
        wp_register_script(
            'xtblocks-control-url',
            xtblocks()->plugin_url() . 'controls/url/script.min.js',
    ...
    public function get_script_depends() {
        return array( 'xtblocks-control-url' );
    }
}

new XT_Blocks_Control_URL();
